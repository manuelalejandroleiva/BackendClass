...
async def update_order_status(
    ...
    return await proxy_request("PATCH", f"{ORDERS_SERVICE_URL}/orders/{order_id}/status", authorization, json={"status": status})

# ===================== RENTALS/VEHICLES =====================
@protected_router.post("/vehicles")
async def create_vehicle(vehicle: VehicleCreate, authorization: Optional[str] = Depends(get_token)):
    return await proxy_request("POST", f"{RENTS_SERVICE_URL}/vehicles", authorization, json=vehicle.dict())
...
async def get_vehicles(
    ...
    return await proxy_request("GET", f"{RENTS_SERVICE_URL}/vehicles", authorization, params=params)
